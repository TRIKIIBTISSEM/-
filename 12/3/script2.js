...
const translateText = (id) => {
    ...
    switch (id) {
        case 'GR': $("#info").html("3 . Ich höre zu, dann setze ich ein Zeichen (<img  id='imgQuestion2' src='image/tic.png'>) unter die Früchte :"); break;
        case 'FR': $("#info").html("3 . J'écoute, puis je mets la marque (<img  id='imgQuestion2' src='image/tic.png'>) sous les fruits :"); break;
        case 'EN': $("#info").html("3 . I listen, then i put a mark (<img  id='imgQuestion2' src='image/tic.png'>) under the fruits :"); break;
        case 'TR': $("#info").html("3 . Dinliyorum, ve meyvelerin altına bir işaret (<img  id='imgQuestion2' src='image/tic.png'>) koyuyorum :"); break;
        default: $("#info").html("3 . J'écoute, puis je mets la marque (<img  id='imgQuestion2' src='image/tic.png'>) sous les fruits :"); break;
    }
