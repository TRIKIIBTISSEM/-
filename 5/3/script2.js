...
const translateText = (id) => {
    ...
    switch (id) {
        case 'GR': $("#info").html("3 . Ich höre zu, dann setze ich eine Markierung unter (<img  id='imgQuestion2' src='image/Layer-8.png'>) jedes Schulwerkzeug:"); break;
        case 'FR': $("#info").html("3 . J'écoute, puis je mets  (<img  id='imgQuestion2' src='image/Layer-8.png'> ) sous les outils scolaires :"); break;
        case 'EN': $("#info").html("3 . I Listen, then i put  (<img  id='imgQuestion2' src='image/Layer-8.png'>) every school tools:"); break;
        case 'TR': $("#info").html("3 . Dinliyorum, ve her okul mazemeleri altına bir işaret (<img  id='imgQuestion2' src='image/Layer-8.png'>) koyuyorum :"); break;
        default: $("#info").html("3 . J'écoute, puis je mets  (<img  id='imgQuestion2' src='image/Layer-8.png'> ) sous les outils scolaires :"); break;
    }
...
const exercice1 = () => {
    switch (pageid) {
        case 1: {
            if ((t1.style.display == "block") && (t2.style.display == "block") && (t3.style.display == "block") && (t4.style.display == "none") && (t5.style.display == "block")) {
