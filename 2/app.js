...
function changeColor(id)
 {
    document.getElementById(id).style.border = ' solid black 7px';
...
function init() {
    ...
    if (numPage % 2 == 0) {
        ...
        $('#let1').css('display', 'block');
        $('#let1').css('margin-top', '10%');
        $('.couleur3').css('margin-right', '0%');
...
function verification() {
    if (sEx ==0) {
        ...
        window.location.href="../2/index1.html";
   // compteur function
